...
use Magetop\Smtp\Model\ResourceModel\AbandonedCart\Grid\Collection;
...
use Magetop\Smtp\Model\Config\Source\DaysRange;
...
class EmailMarketing extends Data
{
    ...
    const API_URL             = 'https://app.mgt.com';
    ...
    public function getProductImage($product)
    {
        ...
        if (!$image) {
            return 'https://cdn1.mgt.com/email-marketing/placeholder-image.gif';
        }
    ...
    {
        if (!$this->smtpVersion) {
            $this->smtpVersion = $this->getModuleVersion('Magetop_Smtp');
        }
