...
class EditPost extends \Magento\Customer\Controller\Account\EditPost implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function __construct(
        ...
        $this->customerMapper = $mapper ?: ObjectManager::getInstance()->get(Mapper::class);
    }
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            try {
                ...
                // ignore logout when change password of core.
                if ($isPasswordChanged) {
                    $this->messageManager->addSuccessMessage(__('You changed password successfully.'));
//                    $this->session->logout();
//                    $this->session->start();
