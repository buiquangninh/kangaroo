...
class AddSpecificAddressAttributeForCustomer implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'specific_address', [
            'type' => 'varchar',
            'input' => 'text',
        ...
        $specificAddressAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'specific_address');
        $specificAddressAttribute->addData([
            'used_in_forms' => ['adminhtml_checkout', 'adminhtml_customer', 'customer_account_edit', 'customer_account_create'],
            'attribute_set_id' => $attributeSetId,
            'attribute_group_id' => $attributeGroup
        ]);
        $specificAddressAttribute->save();
