...
class AssignAreaCode extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $area = $this->getAreaByName($this->stripVN($province));
            if ($area && $this->checkValidAreaCode($area)) {
                $quote = $this->_checkoutSession->getQuote();
                $quote->setAreaCode($area);
    ...
    public function getAreaByName($province){
        return $this->city->create()->load($province,'nonvnese_name')->getArea() ?? '';
    }

    public function getCookie($name)
    {
        return $this->convert->stripVN($this->_cookieManager->getCookie($name));
    }
