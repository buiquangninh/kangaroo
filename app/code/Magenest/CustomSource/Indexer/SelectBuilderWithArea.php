...
class SelectBuilderWithArea extends SelectBuilder
{
    ...
    public function __construct(
        ...
        parent::__construct($resourceConnection, $getIsStockItemSalableCondition, $productTableName);
    }
    ...
    public function execute(int $stockId): Select
    {
        ...
        $select->joinLeft(
            ...
            ['iv' => $this->resourceConnection->getTableName('inventory_source')],
          'iv.source_code = source_item.source_code',
            ['area_code']
        );
        ...
        $select->from(
            ...
            ->group([SourceItemInterface::SKU, 'area_code']);
