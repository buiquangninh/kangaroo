...
use Magenest\MobileApi\Setup\Patch\Data\MaybeInterested as MaybeInterestedDataPatch;
use Magento\CatalogWidget\Block\Product\ProductsList;

class MaybeInterested extends WidgetAbstract
{
    /**
    ...
    /**
     * Render Product Slider Maybe Interested
     */
    public function render()
    {
        $cms_block_sale_today_id = MaybeInterestedDataPatch::MAYBE_INTERESTED_CMS_BLOCK_ID;
        ...
        if ($mainWidget && isset($result[0][0])) {
            ...
            if (!empty($conditions_encoded)) {
                ...
                $maybeInterestItems = $productCollection->load()->getItems();
            }
        }
        ...
        $productIds = [];
        foreach ($maybeInterestItems as $product) {
