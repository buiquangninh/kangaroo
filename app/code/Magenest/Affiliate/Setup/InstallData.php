...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $setup->getConnection()->insertMultiple(
            $setup->getTable('magenest_affiliate_group'),
            [
        ...
        $setup->getConnection()->insert(
            $setup->getTable('magenest_affiliate_campaign'),
    ...
    {
        $homecontent = '<h3>Welcome to our Affiliate Network!</h3>
<p>We are so excited to introduce the easy and profitable business model on Internet to you. It is called Affiliate Program. The most special in Affiliate is you can still receive commission without any products, investment cost or personal website. Our program also don&rsquo;t ask you any experiences in business or technical knowledge. Starting with Affiliate is the ideal starting for the beginners.</p>
<h3>How does it work?</h3>
<p>When you come to Affiliate Program, you just create a new account totally freely for your work. Then you will use available email or text link to sale our website to whoever you want. Commission will be given to you if person you refer clicks on one of our website&rsquo;s links. After a successful purchase, you will receive commission.</p>
<h3>Controlling your work directly!</h3>
<p>Affiliate Program makes you more active in business. You can check your account balance and track directly own transaction anytime.</p>';
