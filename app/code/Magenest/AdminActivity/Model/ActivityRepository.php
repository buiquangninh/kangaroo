...
use Magenest\AdminActivity\Model\Activity\SystemConfig;
 ...
 */
class ActivityRepository implements \Magenest\AdminActivity\Api\ActivityRepositoryInterface
{
	/**
	 * @var string
	 */
	...
	public function __construct(
		...
		\Magenest\AdminActivity\Model\ResourceModel\Activity\CollectionFactory $collectionFactory,
		\Magenest\AdminActivity\Model\ActivityLogDetailFactory $activityLogDetailFactory,
		\Magenest\AdminActivity\Model\ActivityLogFactory $activityLogFactory,
		\Magenest\AdminActivity\Model\ResourceModel\ActivityLog\CollectionFactory $LogCollectionFactory,
		\Magenest\AdminActivity\Model\Activity\SystemConfig $systemConfig,
		\Magenest\AdminActivity\Model\Activity\ThemeConfig $themeConfig,
	...
	public function revertActivity($activity)
	{
		...
		if (\Magenest\AdminActivity\Helper\Data::isWildCardModel($detailModel->getModelClass())) {
