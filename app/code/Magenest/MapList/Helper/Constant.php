...
class Constant
{
    ...
    const STORE_PRODUCT_TABLE = 'magenest_maplist_store_product';
    const HOLIDAY_TABLE = 'magenest_maplist_holiday';
    const HOLIDAY_LOCATION_TABLE = 'magenest_maplist_holiday_location';
    const BRAND_TABLE   =   'magenest_maplist_brand';
    ...
    const STORE_PRODUCT_TABLE_ID = 'store_product_id';
    const HOLIDAY_TABLE_ID = 'holiday_id';
    const HOLIDAY_LOCATION_TABLE_ID = 'holiday_location_id';
    const BRAND_TABLE_ID = 'brand_id';
    ...
    const STORE_PRODUCT_MODEL = 'Magenest\MapList\Model\StoreProduct';
    const HOLIDAY_MODEL = 'Magenest\MapList\Model\Holiday';
    const HOLIDAY_LOCATION_MODEL = 'Magenest\MapList\Model\HolidayLocation';
    const BRAND_MODEL = 'Magenest\MapList\Model\Brand';
    ...
    const STORE_PRODUCT_RESOURCE_MODEL = 'Magenest\MapList\Model\ResourceModel\StoreProduct';
    const HOLIDAY_RESOURCE_MODEL = 'Magenest\MapList\Model\ResourceModel\Holiday';
    const HOLIDAY_LOCATION_RESOURCE_MODEL = 'Magenest\MapList\Model\ResourceModel\HolidayLocation';
    const BRAND_RESOURCE_MODEL = 'Magenest\MapList\Model\ResourceModel\Brand';
}
