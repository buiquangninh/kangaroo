...
namespace Magenest\MapList\Block\Adminhtml\Brand\Helper;

/**
 * Class Logo
 * @package Magenest\MapList\Block\Adminhtml\Brand\Helper
 */
class Logo extends \Magento\Framework\Data\Form\Element\AbstractElement
{
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<thead id="logo_thead" class="logo">' .
            '<tr class="logo">' .
            '<div class="image image-placeholder" id="logo-brand">' .
