...
namespace Magenest\LalaMove\Controller\Webhook;
...
class Hook extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface {
	...
	/**
	 * @var \Magenest\LalaMove\Model\Carrier\LalaMove
	 */
	protected $_helper;
	/**
	 ...
	 * @param \Magenest\LalaMove\Model\Carrier\LalaMove $helper
	 */
	public function __construct(
		\Magento\Framework\App\Action\Context $context,
		\Magento\Framework\App\Request\Http $request,
		\Psr\Log\LoggerInterface $logger,
		\Magenest\LalaMove\Model\Carrier\LalaMove $helper
	) {
