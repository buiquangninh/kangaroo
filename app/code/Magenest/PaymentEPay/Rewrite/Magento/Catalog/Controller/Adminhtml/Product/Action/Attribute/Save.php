...
namespace Magenest\PaymentEPay\Rewrite\Magento\Catalog\Controller\Adminhtml\Product\Action\Attribute;
...
class Save extends \Magento\Catalog\Controller\Adminhtml\Product\Action\Attribute\Save
{
    /**
    ...
    public function execute()
    {
        ...
        $attributesData1 = [];
        $index = 0;
        foreach ($attributesData['installment_options'] as $key => $option) {
            if (isset($option['rate']) && $option['value_type'] == 'fixed') {
                $attributesData1[] = [
                    'record_id' => $index,
                    'rate' => $option['rate'],
                    'value_type' => $option['value_type']
                ];
            } elseif (isset($option['rate']) && $option['value_type'] == 'percent') {
                $attributesData1[] = [
                    'record_id' => $index,
                    'percentage_value' => $option['rate'],
                    'value_type' => $option['value_type']
                ];
            }
            $index++;
        ...
        $attributesData['installment_options'] = $this->serializer->serialize($attributesData1);
