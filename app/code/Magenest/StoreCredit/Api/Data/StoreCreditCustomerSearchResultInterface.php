...
interface StoreCreditCustomerSearchResultInterface extends \Magento\Framework\Api\SearchResultsInterface
{
     ...
     * Get items.
     *
     * @return \Magenest\StoreCredit\Api\Data\StoreCreditCustomerInterface[] Array of collection items.
     */
     ...
     * Set items.
     *
     * @param \Magenest\StoreCredit\Api\Data\StoreCreditCustomerInterface[] $items
     *
     * @return $this
     */
