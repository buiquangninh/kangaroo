...
define([
    ...
    'jquery/ui',
    'mage/validation'
], function ($, mageTemplate, _, niceSelect) {
    'use strict';
    ...
    $.widget('mage.directoryFieldUpdater', {
        ...
        _create: function () {
            ...
            $('.full-directory-information').on('click', function () {
                $('.address-full-details-wrapper').toggleClass('show')
            });
            this.cityIdField.niceSelect();
            // this.cityIdField.niceSelect();
            // this.cityIdField.niceSelect();
            ...
            this.cityIdField.on('change', function () {
                ...
                self.fullAddress = self.cityField.val();
                self._updateFullAddressField();
                self.districtIdField.siblings('.nice-select').remove();
                self.districtIdField.niceSelect();
                self._toggleNextElement(self.districtIdField.siblings('.nice-select'));
            });
            ...
            this.districtIdField.on('change', function () {
                ...
                self.fullAddress = self.districtField.val() + ", " + self.fullAddress;
                self._updateFullAddressField();
                self.wardIdField.siblings('.nice-select').remove();
                self.wardIdField.niceSelect();
                self._toggleNextElement(self.wardIdField.siblings('.nice-select'));
            });
            ...
            this.wardIdField.on('change', function () {
                try {
                    ...
                    self.fullAddress = self.wardField.val()  + ", " + self.fullAddress;
                    self._updateFullAddressField();
                    self._toggleNextElement(false);
                } catch (e) {
                }
            });

            this.cityIdField.siblings('.nice-select').find('li[data-value=' + this.options['defaultCity'] +']').click();
            this.districtIdField.siblings('.nice-select').find('li[data-value=' + this.options['defaultDistrict'] +']').click();
            this.wardIdField.siblings('.nice-select').find('li[data-value=' + this.options['defaultWard'] +']').click();
        ...
        _updateFullAddressField: function () {
            $('.full-directory-information').val(this.fullAddress);
        },

        _toggleNextElement: function (s) {
