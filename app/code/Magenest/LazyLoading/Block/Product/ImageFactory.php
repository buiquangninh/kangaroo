<?php
namespace Magenest\LazyLoading\Block\Product;
...
use Magenest\LazyLoading\Helper\Data as LazyLoadingHelper;
...
class ImageFactory extends \Magento\Catalog\Block\Product\ImageFactory
{
    ...
    public function __construct(
        ...
        parent::__construct($objectManager, $presentationConfig, $viewAssetImageFactory, $viewAssetPlaceholderFactory,
            $imageParamsBuilder);
    ...
    public function create(Product $product, string $imageId, array $attributes = null): ImageBlock
    {
        ...
        if ($this->lazyLoadingHelper->isEnabled()) {
            $data['data']['custom_attributes'] = $this->getStringCustomAttributes($attributes);
            $data['data']['template'] = 'Magenest_LazyLoading::product/image_with_borders.phtml';
        }
