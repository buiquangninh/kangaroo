 ...
 */
class TotalSales extends Column
{
    /**
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $collection->getSelect()
                    ...
                    ->columns('SUM(subtotal) as total_sales')
                    ->group('customer_id');

                if ($collection->getLastItem()['total_sales'] != null) {
                    $item[$fieldName] = $this->formatPrice($collection->getLastItem()['total_sales']);
                } else {
                    $item[$fieldName] = '';
                }
            }
