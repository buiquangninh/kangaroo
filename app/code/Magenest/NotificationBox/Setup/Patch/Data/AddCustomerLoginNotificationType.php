...
class AddCustomerLoginNotificationType implements DataPatchInterface
{
    /**
     * @var DirectoryList
     */
    ...
    public function apply()
    {
        ...
        $data = [
            [
                'name' => Notification::CUSTOMER_LOGIN_LABEL,
                'description' => Notification::CUSTOMER_LOGIN_LABEL,
                'is_category' => 1,
                'default_type' => Notification::CUSTOMER_LOGIN,
                'icon' => '[{
                    "name": "' . Notification::CUSTOMER_LOGIN . '",
                    "type": "image/png",
                    "url": "' . $mediaUrl . $listDefaultImage[Notification::CUSTOMER_LOGIN] . '",
                    "size":"1093"
                }]'
            ]
        ];
