...
use Magenest\NotificationBox\Setup\Patch\Data\AddDefaultNotificationType;
...
class AddMaintenanceNotificationType implements DataPatchInterface
{
    /**
     * @var DirectoryList
     */
    ...
    public function apply()
    {
        ...
        $data = [
            [
                'name' => Notification::MAINTENANCE_LABEL,
                'description' => Notification::MAINTENANCE_LABEL,
                'is_category' => 1,
                'default_type' => Notification::MAINTENANCE,
                'icon' => '[{
                    "name": "' . Notification::MAINTENANCE . '",
                    "type": "image/png",
                    "url": "' . $mediaUrl . $listDefaultImage[Notification::MAINTENANCE] . '",
                    "size":"1093"
                }]'
            ]
        ];
