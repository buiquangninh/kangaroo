...
class AddBirthdayNotificationType implements DataPatchInterface
{
    /**
     * @var DirectoryList
     */
    ...
    public function apply()
    {
        ...
        $data = [
            [
                'name' => Notification::BIRTHDAY_LABEL,
                'description' => Notification::BIRTHDAY_LABEL,
                'is_category' => 1,
                'default_type' => Notification::BIRTHDAY,
                'icon' => '[{
                    "name": "' . Notification::BIRTHDAY . '",
                    "type": "image/png",
                    "url": "' . $mediaUrl . $listDefaultImage[Notification::BIRTHDAY] . '",
                    "size":"1093"
                }]'
            ]
        ];
