...
class AddNewsletterNotificationType implements DataPatchInterface
{
    /**
     * @var DirectoryList
     */
    ...
    public function apply()
    {
        ...
        $data = [
            [
                'name' => Notification::NEWSLETTER_LABEL,
                'description' => Notification::NEWSLETTER_LABEL,
                'is_category' => 1,
                'default_type' => Notification::NEWSLETTER,
                'icon' => '[{
                    "name": "' . Notification::NEWSLETTER . '",
                    "type": "image/png",
                    "url": "' . $mediaUrl . $listDefaultImage[Notification::NEWSLETTER] . '",
                    "size":"1093"
                }]'
            ]
        ];
