...
class AddProductWishlistPromotionsNotificationType implements DataPatchInterface
{
    /**
     * @var DirectoryList
     */
    ...
    public function apply()
    {
        ...
        $data = [
            [
                'name' => Notification::PRODUCT_WISHLIST_PROMOTIONS_LABEL,
                'description' => Notification::PRODUCT_WISHLIST_PROMOTIONS_LABEL,
                'is_category' => 1,
                'default_type' => Notification::PRODUCT_WISHLIST_PROMOTIONS,
                'icon' => '[{
                    "name": "' . Notification::PRODUCT_WISHLIST_PROMOTIONS . '",
                    "type": "image/png",
                    "url": "' . $mediaUrl . $listDefaultImage[Notification::PRODUCT_WISHLIST_PROMOTIONS] . '",
                    "size":"1093"
                }]'
            ]
        ];
