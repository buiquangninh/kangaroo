 ...
 */
class BarContent extends \Magento\Framework\View\Element\Template implements \Magento\Widget\Block\BlockInterface
{
    /**
    ...
    protected $_template = "barcontent.phtml";
    ...
    )
    {
        ...
        $this->setTemplate('barcontent.phtml');
    }
