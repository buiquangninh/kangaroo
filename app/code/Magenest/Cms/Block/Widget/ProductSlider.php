 ...
 */
class ProductSlider extends \Magento\Catalog\Block\Product\AbstractProduct implements BlockInterface, IdentityInterface
{
    /**
    ...
    {
        return $this->getData('show_more_url');
    }
