 ...
 */
class CompleteSupport extends AbstractAction
{
    /**
     * {@inheritdoc}
     */
    ...
    public function execute()
    {
        ...
        if ($order) {
            try {
                ...
                $order->setStatus(Order::ORDER_COMPLETE_SUPPORT);
                $this->orderRepository->save($order);

                $this->messageManager->addSuccessMessage(__('You have confirmed that support is completed.'));
