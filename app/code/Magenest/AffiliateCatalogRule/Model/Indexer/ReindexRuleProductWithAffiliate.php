...
namespace Magenest\AffiliateCatalogRule\Model\Indexer;
...
class ReindexRuleProductWithAffiliate extends ReindexRuleProduct
{
                ...
                foreach ($customerGroupIds as $customerGroupId) {
                    if (!array_key_exists($customerGroupId, $excludedWebsites)
                        ...
                        $rows[] = [
                            ...
                            'is_affiliate' => $rule->getData('is_affiliate')
                        ];
