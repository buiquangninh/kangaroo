...
define([
    ...
    return Listing.extend({
        defaults: {
            ...
            viewConfig: {
                component: 'Lof_FlashSales/js/timeline/timeline-view',
                name: '${ $.name }_view',
                model: '${ $.name }'
            },
            tracks: {
        ...
        _getFirstDay: function () {
            var dates = this._getDates('from_date'),
        ...
        _getLastDay: function () {
            var startDates  = this._getDates('from_date'),
                endDates    = this._getDates('to_date'),
