...
class FileInfo
{
     ...
     */
    const ENTITY_MEDIA_PATH = '/lof_flashsales/tmp/flashsales';
    ...
    private function getFilePath($fileName)
    {
        ...
        // if the file is not using a relative path, it resides in the lof_flashsales/flashsales media directory
