...
class ProductHeaderStyle implements ArrayInterface
{
    /**
     * Header Styles
     */
    ...
    public function toOptionArray()
    {
        $option = [
            [
                ...
                <div>
                    <img src="' . $this->getViewFileUrl('Lof_FlashSales::images/product/product-style1.png') . '">
                </div>'
            ],
            [
                'value' => self::TYPE2,
                ...
                <div>
                    <img src="' . $this->getViewFileUrl('Lof_FlashSales::images/product/product-style2.png') . '">
                </div>'
            ],
            [
                'value' => self::TYPE3,
                ...
                <div>
                    <img src="' . $this->getViewFileUrl('Lof_FlashSales::images/product/product-style3.png') . '">
                </div>'
            ]
        ];
        return $option;
