...
class EventStyle implements ArrayInterface
{
    ...
    public function toOptionArray()
    {
        $option = [
            [
                ...
                <div><img src="'.$this->getViewFileUrl('Lof_FlashSales::images/event/event-style1.png').'"></div>'
            ],
            [
                'value' => self::TYPE2,
                'label' => '<span>'.__('Template 2').'</span>
                <div><img src="'.$this->getViewFileUrl('Lof_FlashSales::images/event/event-style2.png').'"></div>'
            ],
            [
                'value' => self::TYPE3,
                'label' => '<span>'.__('Template 3').'</span>
                <div><img src="'.$this->getViewFileUrl('Lof_FlashSales::images/event/event-style3.png').'"></div>'
            ]
