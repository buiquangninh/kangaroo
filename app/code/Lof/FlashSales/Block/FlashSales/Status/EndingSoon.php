...
class EndingSoon extends \Lof\FlashSales\Block\FlashSales\AbstractEvent
{
    ...
    public function canDisplay()
    {
        return $this->helperData->isEnabled()
            && $this->getFlashSalesEndingCollection()->count();
    }

    /**
     * @return Collection
     */
    public function getFlashSalesEndingCollection()
    {
