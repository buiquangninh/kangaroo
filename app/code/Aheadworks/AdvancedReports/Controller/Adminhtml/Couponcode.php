...
abstract class Couponcode extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $viewContainer->getChildBlock('breadcrumbs')->setTitle(__('Sales by Coupon Code'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Aheadworks_AdvancedReports::reports_couponcode');
    }
}
