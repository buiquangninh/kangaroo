...
abstract class Salesoverview extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $viewContainer->getChildBlock('breadcrumbs')->setTitle(__('Sales Overview'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Aheadworks_AdvancedReports::reports_salesoverview');
    }
}
