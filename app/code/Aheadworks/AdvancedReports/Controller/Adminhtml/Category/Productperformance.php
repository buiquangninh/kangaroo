...
abstract class Productperformance extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $category->load($this->_request->getParam('category_id'));
        $viewContainer->getChildBlock('breadcrumbs')->setTitle($category->getName());
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Aheadworks_AdvancedReports::reports_category_productperformance');
    }
}
