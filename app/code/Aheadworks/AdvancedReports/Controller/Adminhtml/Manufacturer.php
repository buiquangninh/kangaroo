...
abstract class Manufacturer extends \Magento\Backend\App\Action
{
    /**
    ...
    protected function _initAction()
    {
        ...
        $viewContainer->getChildBlock('breadcrumbs')->setTitle(__('Sales by Manufacturer'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Aheadworks_AdvancedReports::reports_manufacturer');
    }
}
