...
abstract class Variantperformance extends \Magento\Backend\App\Action
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Aheadworks_AdvancedReports::reports_productperformance_variant');
    }
}
