...
class SaveHandler implements ExtensionInterface
{
    ...
    private function saveBannerRule($entity, $attributes)
    {
        ...
        $customer_group_ids = $this->getCustomerGroupIds($ruleLinkId);
        if ($bannerRule->getId()) {
        ...
        $bannerRule->setData('customer_group_ids',implode(',',$customer_group_ids));
    ...
    public function getCustomerGroupIds($salesrule_id){
        return $this->rule->create()->load($salesrule_id)->getCustomerGroupIds();
    }
    /**
     * @param \Magento\SalesRule\Model\Rule $entity
     * @param array $attributes
