    ...
    public function afterGetData(\Magento\SalesRule\Model\Rule\DataProvider $subject, $result)
    {
        if (is_array($result)) {
            foreach ($result as &$item) {
                ...
                if (isset($item[BannerInterface::EXTENSION_ATTRIBUTES_KEY][BannerInterface::DISPLAY])) {
                    $item[BannerInterface::DISPLAY] = $item[BannerInterface::EXTENSION_ATTRIBUTES_KEY][BannerInterface::DISPLAY];
                }
            }
        }
